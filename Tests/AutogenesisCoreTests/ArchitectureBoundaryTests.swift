...
struct ArchitectureBoundaryTests {
    ...
    func transientRenderMemoryUsesPerSubmissionResidencyAndQueueBarriers() throws {
        ...
        #expect(!renderer.contains("abandonInFlight"))
        #expect(renderer.contains("old epoch's resources quarantined"))
        #expect(renderer.contains("syntheticRetiredCommandBuffers"))
