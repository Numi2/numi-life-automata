...
- **Morphology from membrane construction.** The renderer contains no abdomen, jaw, spine, organism sprite, or decorative limb primitive. A continuous organism silhouette appears only when exposed cells have paid to construct integument and transmit its tension through physical junctions. Leg-like locomotor appendages are elongated simulated membrane vertices of motile lateral boundary cells; their alternating gait is the same state that produces terrain-dependent traction.
