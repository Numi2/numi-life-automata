...
| Visible-junction index buffer | `32,768 x 4 B` | Compacted junction-table indices | GPU private | Valid, recent, visible persistent bonds selected without CPU traversal |
| Junction indirect draw arguments | `4 x 4 B` | `MTLDrawPrimitivesIndirectArguments` | Shared | GPU-written visible-junction count for causal ribbon submission |
